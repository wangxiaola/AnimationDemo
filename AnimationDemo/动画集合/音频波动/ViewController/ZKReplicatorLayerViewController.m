//
//  ZKReplicatorLayerViewController.m
//  AnimationDemo
//
...
#import "ZKReplicatorLayerViewController.h"

@interface ZKReplicatorLayerViewController ()

@end

@implementation ZKReplicatorLayerViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"音频波动动画";
