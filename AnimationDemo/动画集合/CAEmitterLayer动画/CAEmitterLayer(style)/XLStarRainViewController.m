...
#import "XLStarRainViewController.h"
#import <QuartzCore/CoreAnimation.h>
@interface XLStarRainViewController ()

@end

@implementation XLStarRainViewController
@synthesize ringEmitter;
- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"星雨发散";
