...
#import "XLFlameViewController.h"
#import <QuartzCore/CoreAnimation.h>

@interface XLFlameViewController ()

@end

@implementation XLFlameViewController
@synthesize fireEmitter,smokeEmitter;

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"火焰燃烧";
